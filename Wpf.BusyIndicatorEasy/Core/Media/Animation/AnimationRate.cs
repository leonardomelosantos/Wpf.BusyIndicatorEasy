...
using Wpf.BusyIndicatorEasy.Core;
...
namespace Wpf.BusyIndicatorEasy.Media.Animation
{
    ...
    public struct AnimationRate
    {
        ...
        {
            get { return (_rateType == RateType.TimeSpan); }
        }
        ...
        {
            get { return (_rateType == RateType.Speed); }
        }
        ...
        [FieldOffset(0)] private long _duration;
        [FieldOffset(0)] private double _speed;
        [FieldOffset(8)] private RateType _rateType;
