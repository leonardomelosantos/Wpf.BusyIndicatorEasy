...
namespace Wpf.BusyIndicatorEasy.Core.Utilities
{
    internal static class RectHelper
    {
        ...
        public static Nullable<Point> GetNearestPointOfIntersectionBetweenRectAndSegment(Rect rect, Segment segment,
            Point point)
        {
        ...
        private static void AdjustResultForIntersectionWithSide(ref Nullable<Point> result, ref double distance,
