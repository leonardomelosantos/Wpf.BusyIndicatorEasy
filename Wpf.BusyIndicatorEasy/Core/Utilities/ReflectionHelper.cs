...
namespace Wpf.BusyIndicatorEasy.Core.Utilities
{
    internal static class ReflectionHelper
    {
            ...
            out string propertyOrFieldName)
        {
            ...
            return ReflectionHelper.TryGetPropertyOrFieldName(expression.Body as MemberExpression,
                out propertyOrFieldName);
        }

        public static bool IsPublicInstanceProperty(Type type, string propertyName)
        {
            BindingFlags flags = (System.Reflection.BindingFlags.Instance |
