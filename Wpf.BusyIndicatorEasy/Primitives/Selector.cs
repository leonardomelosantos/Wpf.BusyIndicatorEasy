...
using Wpf.BusyIndicatorEasy.Core.Utilities;
    ...
    public class Selector : ItemsControl, IWeakEventListener
    {
        ...
        public Selector()
        {
            ...
            AddHandler(Selector.SelectedEvent,
                new RoutedEventHandler((s, args) => this.OnItemSelectionChangedCore(args, false)));
            AddHandler(Selector.UnSelectedEvent,
                new RoutedEventHandler((s, args) => this.OnItemSelectionChangedCore(args, true)));
        ...
        {
            get { return ItemsSource ?? ((IEnumerable) Items ?? (IEnumerable) new object[0]); }
        }
        ...
        private void UpdateFromSelectedValue()
        {
            ...
            if (!String.IsNullOrEmpty(SelectedValue))
            {
                List<string> selectedValues =
                    SelectedValue.Split(new string[] {Delimiter}, StringSplitOptions.RemoveEmptyEntries).ToList();
